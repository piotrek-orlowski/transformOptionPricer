...
#'
#' @param strikeMat T x K x 1 array
...
#' 
option_price_with_greeks <- function(strikeMat
                                     , mkt
                                     , type = c("call", "put", "otm")
                                     , N = 192L
                                     , intLim
  ...
  # expand strikeMat for the calculation of Greeks Tue Jun 04 13:18:08 2019 ------------------------------
  # strikeMat is T x K x 1
  # In order to calculate the Greeks, we will have to expand it to T x K x 9 and adjust strikes in a number of positions
  # strikeMat[,,1]: pricing at S.0, v.0
  # strikeMat[,,2]: pricing at S.0, v.0 - dv
  # strikeMat[,,3]: pricing at S.0, v.0 + dv
  # strikeMat[,,4]: pricing at S.0 + ds, v.0
  # strikeMat[,,5]: pricing at S.0 - ds, v.0
  # strikeMat[,,6]: pricing at S.0 - ds, v.0 - dv
  # strikeMat[,,7]: pricing at S.0 + ds, v.0 + dv
  # strikeMat[,,8]: pricing at S.0 - ds, v.0 + dv
  # strikeMat[,,9]: pricing at S.0 + ds, v.0 - dv
  ...
  strike_mat_expanded <- lapply(1:9, function(x) strikeMat)
